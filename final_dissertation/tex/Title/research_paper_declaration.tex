...
\noindent Not applicable. The manuscript described below is under review and has
not been published, so section~1 is skipped as the form directs.
...
\begin{description}[leftmargin=1.4em, style=nextline, itemsep=0.35em]
    ...
    In submission; under review at both venues at the time of thesis submission.
\end{description}
...
\begin{description}[leftmargin=1.4em, style=nextline, itemsep=0.3em, topsep=0.3em]
    ...
    \item[Adriano Koshiyama] \textbf{[[TO FILL]]}
