...
fair-coin model of which tasks flip --- below the threshold we derive for what a
single repetition of that arm can produce on its own. Two runs do not pin down
