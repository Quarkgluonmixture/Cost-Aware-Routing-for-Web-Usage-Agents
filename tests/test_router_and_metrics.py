    ...
    episodes = [
        {
            ...
            "steps": 2, "total_latency_minus_retry_ms": 0.0, "busy_wait_total_ms": 0.0,
        ...
        },
        {
            ...
            "steps": 3, "total_latency_minus_retry_ms": 0.0, "busy_wait_total_ms": 0.0,
    ...
    episodes = [
        {
            ...
            "steps": 1, "total_latency_minus_retry_ms": 0.0, "busy_wait_total_ms": 0.0,
