...
def main() -> int:
    ...
    lines = [
        ...
        "> The canonical paper §1 H1 PRIMARY gate (per `preregistration.md` §2 H1 L98 + AMENDMENT_02 §2)",
        "> is the **P-SoM drop-one bootstrap-percentile superiority test against δ=1.0pp**, computed by",
        "> `aggregate_phase1_full_prereg_decision.py` → `results/phantom_paper/phase1_full_prereg_decision.{csv,json,md}`",
        "> (legacy `phase1_prereg_gate.*` is transparency-only normal-Z per AMENDMENT 03 2026-05-24).",
        ...
        "> from paper §1 hero prose. Cite `phase1_full_prereg_decision.md` for §1 hero.",
        "",
        ...
        "",
        "**Hierarchy (LEGACY APPENDIX framing; canonical paper-grade family is in `phase1_full_prereg_decision.md`)**:",
        "",
