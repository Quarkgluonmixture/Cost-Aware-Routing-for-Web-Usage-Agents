...
Poster: `poster_jiaming_wei.pdf` — **v8.3, 2026-09-03** (A1 594×841mm, 1 page, fonts
embedded, figures 300–350dpi). Numbers, their scope and the version history:
`poster_content.md` (read its v8.3/v8.2/v8 headers first). `EXHIBITION_PASS.md` is the
...
| When | What | Status |
|---|---|---|
| **Thu 4 Sep** | Send Zekun (Slack DM) the v8.3 PDF + the oral-slot pitch (§1). Organiser confirmed a replacement PDF is accepted until today; after this it is self-print A1 | ☐ |
