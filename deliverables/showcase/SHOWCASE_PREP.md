...
| `2–4×` (talk `why`, `not-yet`) | the `2.1–4.2×` row above, rounded for the slide | keep "at least"; "scaling law" on that slide is a label for "more wins → more examples" over six settings, not a fitted law |
