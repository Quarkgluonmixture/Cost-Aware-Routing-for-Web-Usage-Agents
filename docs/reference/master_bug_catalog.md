...
| ⏳ **COMMIT B (next round)** | 6 | B-138 (API probe / P0-9) / B-139 (image_token_method flag / P1-3) / B-140 (image_meta mandatory / P1-5) / B-141 (parser robust / P1-6) / B-142 (coord validation / P1-7) / B-143 (retry latency separate / P1-9) |
