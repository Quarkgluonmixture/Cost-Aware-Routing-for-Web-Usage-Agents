...
#### §150 NEW ARTIFACTS — deferred to follow-up issue

- **B-184** `phase1_prereg_gate.{csv,json,md}` ⏳ **DEFER** (codex B2, P0 OOB, 0.5-1 day scope) — canonical FE drop-one over 6 cells + one-sided z superiority test. The paper §1 H1 hero claim source-of-truth that `aggregate_phantom_lift.py` legacy 3→5 estimand should be DEMOTED to appendix in favor of. Tracked in `_status/issues/issue_phase1_canonical_artifacts_2026-05-16.md`.
...
| ⏳ **DEFER (new artifact build)** | 3 | B-184 / B-185 / B-186 — phase1_prereg_gate / claim_manifest / hero_metrics (0.5-3 day scope; A1.4b-i follow-up issue) |
...
**Next available B-number**: B-187+ (B-184/B-185/B-186 reserved by issue file but not yet built).
