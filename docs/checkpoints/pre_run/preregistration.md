...
scope_revision_2026_05_14: B2 = Gemma3-VL `google/gemma-3-4b-it` added as 3rd baseline (matched-capability cross-family control vs B1 4B); Phase 1a expanded cls+red × B0+B1+B2 × 6 modes = 36 operational conditions across 6 statistical cells; per-cell power numbers at k=6 pending advisor lock (see §2.4 TODO)
...
1. Advisor sync session: lock **14 commit decisions** (expanded 5/4 audit + 2026-05-13 + 2026-05-14 "3A" + 2026-05-14 B2 + 2026-05-15 A100/router revisions):
   ...
   - (10) **B2 baseline addition** (2026-05-14): Gemma3-VL `google/gemma-3-4b-it` (4B params) added as cross-family matched-capability control vs B1 4B. k=4 → k=6 cells. Power numbers at k=6 ⏳ pending advisor lock.
