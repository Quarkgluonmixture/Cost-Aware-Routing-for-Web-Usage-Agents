...
1. Advisor sync session: lock **14 commit decisions** (expanded 5/4 audit + 2026-05-13 + 2026-05-14 "3A" + 2026-05-14 B2 + 2026-05-15 A100/router revisions):
   ...
   - Plus lock gating H-list: **H1-H3 only** for this DOI; H5/H6 post-hoc disclosure + H7/H8 paper-2 deferred + H9/H10 paper-1 router (estimand pending separate lock).
...
| \<pending advisor sync\> | \<witness 14 lock decisions per §6 — incl. estimand=FE-over-6-planned-cells, K-of-N transparency-count-no-threshold, δ=1.0pp FE superiority, H2(a) by-construction, H1-H3 gating only, B2 added 2026-05-14, host=A100 migrated 2026-05-15, paper-1 router scope (H9/H10 estimand pending), mechanism §5 paper-2 deferred, H7/H8 paper-2 deferred\> | \<advisor email reply timestamp + Git SHA at lock\> |
| \<pending advisor email follow-up\> | \<witness K_h1=0.75 transparency / K_h3=0.67 transparency / TOST δ=1.0pp / N_conditions=36 (Phase 1a) / N_cells=6 / split protocol / paper split / Phase 1b shop / outcome-indep smoke gate / B2 matched-capability rationale / A100 host migration / paper-1 H9/H10 router estimand / power re-derivation at k=6 / per follow-up doc Q1-Q11+\> | \<email reply timestamp + Git SHA at lock\> |
