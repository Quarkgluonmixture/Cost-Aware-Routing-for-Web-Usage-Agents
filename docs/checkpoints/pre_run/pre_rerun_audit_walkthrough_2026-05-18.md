...
| 7 | **Version / dependency pinning** | `locked_versions.md` (single source) | VWA submodule SHA `2f9b0b47175a1bffa01e13100e3075e212161a89` (A1.18-re Chunk 1 + A2.7 P0-1-B* sync 2026-05-18 supersedes `1c3a615` + `eb5cbd8` + `f0c835b`); B1 HF SHA `ebb281ec...`; **B2 HF SHA `093f9f388b31de276ce2de164bdc2081324b9767` locked 2026-05-18 per B-1603**; Playwright 1.58.0; Chromium revision 1208 | ✅ |
...
| 3 | `vwa_*.json` snapshot committed | ✅ tree-hash chain witness `5c6c5f625f44ca1b2155b9cad280b5aecb3e6939cf0599540fcef0900028fb0f` matches lock; committed at lock event |
