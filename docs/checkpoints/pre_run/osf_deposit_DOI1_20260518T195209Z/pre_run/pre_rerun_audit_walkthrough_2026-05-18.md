...
| 7 | **Version / dependency pinning** | `locked_versions.md` (single source) | VWA submodule SHA `ac33d2fcd9cec2fcbeddd56d0fa3da58b4c7e927` (A1.18-re Chunk 1 + A2.7 P0-1-B* sync 2026-05-18 supersedes `1c3a615` + `eb5cbd8` + `f0c835b`); B1 HF SHA `ebb281ec...`; **B2 HF SHA `093f9f388b31de276ce2de164bdc2081324b9767` locked 2026-05-18 per B-1603**; Playwright 1.58.0; Chromium revision 1208 | ✅ |
...
| 3 | `vwa_*.json` snapshot committed | ✅ tree-hash chain witness `752caebdc6bd84761b2f308331f21241a9b4a28de65b46ff0007ef27d8c72778` matches lock; committed at lock event |
