...
| `locked_versions.md` | `docs/checkpoints/pre_run/locked_versions.md` | ✅ VWA SHA `2f9b0b4...` + B1 HF `ebb281e...` + **B2 HF `093f9f3...` locked 2026-05-18 B-1603** + Playwright 1.58.0 + Chromium revision 1208 | All pins current |
...
| Submodule pin verification | VWA `external/visualwebarena` HEAD `2f9b0b47175a1bffa01e13100e3075e212161a89` + tree-hash chain `5c6c5f625f44ca1b2155b9cad280b5aecb3e6939cf0599540fcef0900028fb0f` | Captured in `env_snapshot_a100_lock.json` (Step 3) |
...
| B-91 LLM-judge polarity fix | VWA submodule `external/visualwebarena/p79-patches` branch `eb5cbd8` + `evaluation_harness/helper_functions.py:612-613` | Embedded in submodule HEAD `2f9b0b4`; tree-hash chain matches lock |
