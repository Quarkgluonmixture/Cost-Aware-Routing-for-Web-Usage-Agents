...
- `docs/checkpoints/preregistration.md` (FP filter primary spec)
- `docs/checkpoints/reeval_audit_protocol.md` (Protocol B — episode-level audit trail)
- `docs/checkpoints/osf_lock_manifest.md` (lock-time SHA capture)
