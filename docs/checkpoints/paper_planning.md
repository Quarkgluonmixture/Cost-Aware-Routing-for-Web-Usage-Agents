...
| Field | **Paper-1 Workshop (workshop_R1, B-1601 /stress A2.6c P0-2-A* 2026-05-18)** | **Paper-1 Main (NeurIPS/ICLR/ICML cascade)** | **Track A Workshop (methodology)** | **Track B Workshop (evaluation systems)** |
|---|---|---|---|---|
