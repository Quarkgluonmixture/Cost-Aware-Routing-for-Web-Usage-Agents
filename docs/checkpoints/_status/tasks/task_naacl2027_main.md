...
🔴 **2026-08-16 更正 (user)**: REALM 出结论是 **08-21**, 不是 09-07。

```
旧(作废) 08-08 ──24天── 09-01 毕设硬截止 ──6天── 09-07 REALM notif ──35天── 10-12 ARR
新        08-16 ──5天── 08-21 REALM notif ──11天── 09-01 毕设硬截止 ──41天── 10-12 ARR
                        └──────────────── 52 天到 ARR ────────────────┘
```

**这个更正把局面改好了, 不是改坏**: 审稿意见现在落在毕设交付**之前 11 天**, 而不是之后 6 天。
- REALM 意见到手 → ARR = **52 天**（旧: 35 天）
- 补实验可比原计划**早 17 天**启动

⇒ **补实验必须与毕设写作并行** 这条不变, 但理由更强了: 意见在 08-21 就到, 那时毕设还有
11 天要写, 而 GPU 正好空着。等 09-01 之后再启动等于白白扔掉那 11 天的 GPU 时间。
...
1. **REALM 审稿意见 (2026-08-21, user 08-16 更正; 旧记 09-07 作废)** — 免费的一轮 top-tier 反馈, **落在毕设交付之前 11 天**（旧文档写"之后", 已随日期一并更正）。决定「按原框架投还是重构」的主要依据, **等它到手再定稿件形态**。
