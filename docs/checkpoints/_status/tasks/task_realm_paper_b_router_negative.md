...
horizon: now
order: 1
blocker: "🔄 **框架转向执行中 (2026-08-01 夜, 笔记 §407)** — 六模式 phantom 分类学 → **文本/视觉/融合三分**; 旧②(H3 两轴)消失, 2×2 降为 §2 构造效度检查 ⇒ 页数之战自动解决(省掉 taxonomy 铺陈)。08-03 对账改拍: 认不认三分骨架 / 认不认非归档轨 / A 的负面证据只有 WA 一格真撑要不要收口 / 要不要补第三个工作负载。看板 deliverables/duizhang_board_2026-08-03.html 待按新骨架重出"
eta: "2026-08-05 周三 (REALM @ EMNLP 2026, **改投 Non-archival long**, 双盲 ACL, 8 页 — 见 issue_realm_archival_track_2026-08-01)"
