...
|---|---|---|---|---|
| DOM | SoM | AXTree | **L04** | 0.0604 |
| DOM | Vision | AXTree | **L04** | 0.0653 |
| P-prompt | SoM | AXTree | **L04** | 0.0600 |
| P-prompt | Vision | AXTree | **L04** | 0.0649 |
| P-SoM | SoM | [SOM_MARKS] | **L17** | 0.0412 |
| P-text | SoM | [SOM_MARKS] | **L20** | 0.0494 |
| P-text | Vision | [SOM_MARKS] | **L36** | 0.0614 |
| P-SoM | Vision | [SOM_MARKS] | **L36** | 0.0613 |

## Grouped by no-image side text format

### no-image text = `AXTree` (mean peak L4)

- DOM ↔ SoM: peak **L04** = 0.0604
- DOM ↔ Vision: peak **L04** = 0.0653
- P-prompt ↔ SoM: peak **L04** = 0.0600
- P-prompt ↔ Vision: peak **L04** = 0.0649

### no-image text = `[SOM_MARKS]` (mean peak L27)

- P-text ↔ SoM: peak **L20** = 0.0494
- P-text ↔ Vision: peak **L36** = 0.0614
- P-SoM ↔ SoM: peak **L17** = 0.0412
- P-SoM ↔ Vision: peak **L36** = 0.0613
