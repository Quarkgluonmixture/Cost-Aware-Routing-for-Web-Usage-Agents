...
> - **push 状态**: `cd5029e`(cap)+`fdee922`(§344) + 前置 6 commits **已 push** `origin/fix/b1878-reddit-reference-image` (2026-06-19); **未 push = `95a8d2b` (idle-alert) + 本次文档 commit**。push 需 user 确认。
