...
> - **paper prose follow-up (sequential reconcile, §295; 非 block)**: section1 hero · section3 §3.5 portability ("at most a regex pass" → "regex + sequential renumber + seq→native map") · Risk6 · phase1_plan §D4 — 下次 prose-write 落(AMENDMENT_07 已是 authoritative 记录;section2 axis-1 + section3 H3 已改)。
