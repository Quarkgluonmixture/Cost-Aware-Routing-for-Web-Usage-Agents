...
> 3. **OSF DOI 1 mint TODAY ⭐⭐⭐ + DOI 2 post-Pass-1+Pass-2+analysis-frozen ⭐⭐** — Two-DOI split locked 2026-05-18 ~14:00 UTC per /stress doctrine restoration (B-1650~B-1655, restores 2026-05-05 §F.1 pre-data DOI ordering): **DOI 1 = pre-outcome-creation witness** (mint NOW while 0 outcome artifacts exist per [[artifact_existence_check_doi1_20260518T135722Z]] empirical witness — 3-tier check episode=0/condition=0/steps=0; OSF submission timestamp = cryptographic anchor, DOI string auto-assigned 48h via admin approval per help.osf.io/article/330). **DOI 2 = reproducibility bundle** (mint trigger: Pass-1+Pass-2 complete + analysis scripts frozen + paper §1-§8 finalized; ~2-3 weeks post-fire). 详 [[osf_lock_manifest]] §3a (DOI 1 today) + §3b (DOI 2 post-data) + [[DOI_1_README]].
