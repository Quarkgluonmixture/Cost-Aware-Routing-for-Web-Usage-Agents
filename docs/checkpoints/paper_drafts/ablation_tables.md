...
<!-- GENERATED 2026-08-03T23:04:24+00:00 — do not hand-edit between the table markers; rerun the producer instead. -->
...
| cell | signals | margin over same-size random escalation (10% / 20% / 30%) | oracle headroom captured (10% / 20% / 30%) |
|---|---|---|---|
| cls·B0 | 8 | +1.12pp / +1.78pp / +2.01pp | 15% / 25% / 30% |
| cls·B1 | 10 | +1.16pp / +1.43pp / +2.14pp | 20% / 27% / 40% |
| cls·B2 | 10 | +0.45pp / +0.89pp / +0.45pp | 20% / 40% / 20% |
| red·B0 | 10 | +1.74pp / +1.46pp / +0.74pp | 23% / 27% / 27% |
| red·B1 | 8 | +1.49pp / +1.96pp / +1.48pp | 33% / 50% / 50% |
| red·B2 | 9 | +0.10pp / +0.20pp / +0.30pp | 0% / 0% / 0% |
| WA·B0 | 10 | +3.57pp / +3.26pp / +3.95pp | 36% / 36% / 45% |
| WA·B1 | 9 | +2.51pp / +2.11pp / +2.70pp | 43% / 43% / 57% |

*Table 21: Cascade signal against a random-escalation control. Is the cascade's signal doing anything? Table 20 answers a deployment question — no operating point Pareto-beats always-rich — which on its own cannot distinguish a signal that carries nothing from one that carries something insufficient. This is the comparator that separates them: the same escalation budget spent at random. The margin is positive in **24 of 24** (cell × fraction) combinations, so the ranking is informative even where the policy loses; the right-hand column says how much of the gap to a per-task oracle that ranking recovers. **Caution:** **These are in-sample maxima**: the best signal is chosen per (cell, fraction) from the cell's menu against realised outcomes, so they bound what an out-of-fold selection could deliver rather than estimate it. The offline-splice caveat on Table 20 applies unchanged. Source: `confidence_cascade_with_wa.json`.*
