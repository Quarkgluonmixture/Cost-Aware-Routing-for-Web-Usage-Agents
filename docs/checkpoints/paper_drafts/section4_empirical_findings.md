...
The second knob is commitment confidence. On the same N=48 subset, DOM and P-text have identical raw-to-adjusted SR gaps, while Phantom-SoM has a smaller gap:
