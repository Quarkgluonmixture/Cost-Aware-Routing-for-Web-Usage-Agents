...
Cross-link: 实验笔记 §237 (full RCA chronicle) + §241/§242 (Fire-6 Stage C + GRL audit), preregistration Appendix E (additive disclosure framing + invalidation thresholds + terminal mapping), master_bug_catalog P0-1-ABC* / P0-8-C* / P1-10-B / P1-11-B* / B-1764 (Rule 2) / B-1770~B-1773 + B-1779 (resolution mechanism).
