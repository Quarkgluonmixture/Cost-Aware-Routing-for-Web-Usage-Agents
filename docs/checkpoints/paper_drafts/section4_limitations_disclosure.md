...
Cross-link: 实验笔记 §237 (full RCA chronicle), preregistration Appendix E (additive disclosure framing + invalidation thresholds + terminal mapping), master_bug_catalog P0-1-ABC* / P0-8-C* / P1-10-B / P1-11-B*.
