...
| Output divergence | Exp 3 logit lens (§5.7) | **Re-run pending** on v2 NPZ. V1 reported KL 0.16 at L23 axis-2 + KL 0.69 at L23 axis-1; V2 likely revises both. Mechanism direction (lm_head amplifies residual into output KL) probably survives; magnitudes will change |
