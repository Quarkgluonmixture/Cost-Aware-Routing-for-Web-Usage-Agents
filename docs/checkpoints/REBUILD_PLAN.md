...
| Stage-2B continuation patching `p1_fwd_strong_red` | DGX pid 38617 | ✅ **finished 07-28 03:34** (earlier than its 08-01 self-truncation) | — | §5 mechanism, **shelved** by advisor 2026-05-14 ⇒ archive only, feeds no current paper |
