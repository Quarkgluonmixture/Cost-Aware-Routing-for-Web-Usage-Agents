...
| 字段 | 值 |
|---|---|
| Run | `B2_phantom_som_classifieds_20260615_044451_093238285_1626673_R22577` |
| Episodes | 224（success 2 · SR 0.89%） |
| 三子集 | failed+hit 217 · failed-NO-hit 5 · success+hit 0 |
| config_missing | 0 |

| 规则 | 含义 | step 级 | episode 级 |
|---|---|---:|---:|
| `P36` | WALK_FAIL_DEGENERATE | 1641 | 179 |
| `P31` | budget耗尽未完成 | 134 | 134 |
| `P5` | 感知缺失循环 | 215 | 122 |
| `P45` | IDENTICAL_FAILED_ACTION_STREAK | 188 | 114 |
| `P14` | URL 自环 | 114 | 97 |
| `P4` | 根节点误操作 | 278 | 89 |
| `P43` | PAGE_EMBEDDED_VISUAL_NO_SCREENSHOT | 71 | 71 |
| `P12` | 从不翻页 | 46 | 46 |
| `P33` | 导航至裸图片URL幻觉 | 46 | 46 |
| `P44` | HALLUCINATED_ELEMENT_REF | 104 | 43 |
