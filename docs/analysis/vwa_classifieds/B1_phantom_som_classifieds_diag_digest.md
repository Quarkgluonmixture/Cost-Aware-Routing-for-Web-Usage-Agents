...
| 字段 | 值 |
|---|---|
| Run | `B1_phantom_som_classifieds_20260606_165421_042595838_568395_R26199` |
| Episodes | 224（success 15 · SR 6.70%） |
| 三子集 | failed+hit 193 · failed-NO-hit 16 · success+hit 0 |
| config_missing | 0 |

| 规则 | 含义 | step 级 | episode 级 |
|---|---|---:|---:|
| `P36` | WALK_FAIL_DEGENERATE | 1047 | 124 |
| `P5` | 感知缺失循环 | 155 | 96 |
| `P45` | IDENTICAL_FAILED_ACTION_STREAK | 103 | 78 |
| `P43` | PAGE_EMBEDDED_VISUAL_NO_SCREENSHOT | 69 | 69 |
| `P4` | 根节点误操作 | 443 | 63 |
| `P31` | budget耗尽未完成 | 55 | 55 |
| `P17` | click-back振荡 | 48 | 48 |
| `P14` | URL 自环 | 46 | 38 |
| `P18` | cheapest漏价格排序 | 31 | 31 |
| `P20` | 评测目标页从未访问 | 20 | 20 |
| `P19` | url_match过早搜索页finish | 14 | 14 |
| `P25` | 跨站任务跳过其中一站 | 13 | 13 |
| `P7` | sCity=州名 | 14 | 13 |
| `P12` | 从不翻页 | 13 | 13 |
| `P30` | 到达正确item后离开 | 10 | 10 |
| `P33` | 导航至裸图片URL幻觉 | 7 | 7 |
| `P13` | 搜索代替浏览 | 7 | 7 |
| `P27` | 找不到即放弃 | 7 | 7 |
| `P10` | 跨步数值记忆失败 | 5 | 5 |
| `P24` | 不确定仍finish | 5 | 5 |
| `P44` | HALLUCINATED_ELEMENT_REF | 9 | 5 |
| `P2` | 容器节点误点 | 4 | 3 |
| `P23` | oldest误用价格排序 | 3 | 3 |
