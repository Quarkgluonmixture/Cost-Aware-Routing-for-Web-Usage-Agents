...
Generated: 2026-04-29 23:08 UTC  
...
- reddit: DOM raw 11.43% / adj **9.52%**; P-text raw 13.81% / adj **12.38%**; P-prompt raw 10.56% / adj **9.15%**; P-SoM raw 14.29% / adj **13.81%**; SoM raw 11.90% / adj **10.48%**; Vision raw 8.57% / adj **6.67%**
...
- source: `results/visualwebarena/phase1/B0_*/*/episodes/*_summary_v2.json` (live); last update: 2026-04-29 23:07 UTC
- standalone cite source: `docs/analysis/cross_sites/sr_fp_per_mode.md` | last update: 2026-04-29 23:08 UTC

### 0b FP rate (raw success - adjusted success)

- reddit: DOM 1.90%; P-text 1.43%; P-prompt 1.41%; P-SoM 0.48%; SoM 1.43%; Vision 1.90%
- classifieds: DOM 0.85%; P-text 2.14%; P-SoM 1.28%; SoM 1.71%; Vision 2.14%
- source: same live episode `summary_v2.json` files as 0a; standalone `docs/analysis/cross_sites/sr_fp_per_mode.md` | last update: 2026-04-29 23:08 UTC
...
- source: `docs/analysis/cross_sites/mechanism_per_task.json` | last update: 2026-04-29 23:08 UTC
...
- reddit: **+4.23pp** [1.41, 7.75] Wilcoxon p=0.0143, McNemar p=0.0156 ✅
  - single phantom lifts: +P-text +2.82pp; +P-SoM +2.82pp
- source: `results/phantom_paper/phantom_lift.csv` | last update: 2026-04-29 23:08 UTC
- figures: `results/phantom_paper/figures/fig0c_drop_one_oracle.png`, `results/phantom_paper/figures/fig0c_phantom_lift_bars.png` | last update: 2026-04-29 23:08 UTC

### 0d Task-pool Jaccard (Scenario C sentinel)

- classifieds: P-text↔P-SoM Jaccard **0.447** (✅ safe); threshold ≤0.7
- reddit: P-text↔P-SoM Jaccard **0.526** (✅ safe); threshold ≤0.7
- source: `results/phantom_paper/phantom_lift.csv` | last update: 2026-04-29 23:08 UTC
- figure: `results/phantom_paper/figures/fig0d_taskpool_jaccard.png` | last update: 2026-04-29 23:08 UTC
...
- figure: `results/phantom_paper/figures/fig0e_category_mode_heatmap.png` | last update: 2026-04-29 23:08 UTC

### 0f Overlap depth

- reddit P-SoM: d1=2 / d2=8 / d3=5 / d4=9 / d5=4 / d6=1
- reddit P-text: d1=4 / d2=4 / d3=4 / d4=9 / d5=4 / d6=1
- reddit P-prompt: d1=4 / d2=1 / d3=1 / d4=3 / d5=3 / d6=1
- classifieds P-SoM: d1=3 / d2=7 / d3=7 / d4=10 / d5=7 / d6=0
- classifieds P-text: d1=5 / d2=7 / d3=7 / d4=8 / d5=7 / d6=0
- figure: `results/phantom_paper/figures/fig0f_overlap_stacked_bar.png` | last update: 2026-04-29 23:08 UTC
...
- source: `results/phantom_paper/auroc_cross_condition.csv` | last update: 2026-04-29 23:08 UTC
- figure: `results/phantom_paper/figures/fig0g_routing_auroc_heatmap.png` | last update: 2026-04-29 23:08 UTC
...
- source: `docs/analysis/cross_sites/axis_effect_size.json` | last update: 2026-04-29 23:08 UTC
...
- figure: `results/phantom_paper/figures/fig1c_strategy_gradient.png` | last update: 2026-04-29 23:08 UTC
...
- source: `docs/analysis/cross_sites/axis1_microbehavior.json` | last update: 2026-04-29 23:08 UTC
- figure: `results/phantom_paper/figures/fig2_micro_divergence_heatmap.png` | last update: 2026-04-29 23:08 UTC
...
- source: `results/phantom_paper/run_summary_collect.json` plus episode `total_tokens` fallback | last update: 2026-04-29 23:08 UTC
...
- source: `docs/analysis/cross_sites/cost_per_mode.json` | last update: 2026-04-29 23:08 UTC
- figure: `results/phantom_paper/figures/fig3d_cost_sr_frontier.png` | last update: 2026-04-29 23:08 UTC
