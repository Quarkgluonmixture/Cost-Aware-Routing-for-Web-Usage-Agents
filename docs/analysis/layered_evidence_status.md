...
Generated: 2026-08-13 09:04 UTC
...
- canonical source: `docs/analysis/cross_sites/sr_per_mode.json` | last update: 2026-08-12 04:30 UTC
- standalone cite source: `docs/analysis/cross_sites/sr_per_mode.md` | last update: 2026-08-12 04:30 UTC
...
- source: `docs/analysis/cross_sites/mechanism_per_task.json` | last update: 2026-08-12 04:31 UTC
...
- source: `results/phantom_paper/phantom_lift.csv` | last update: 2026-08-12 04:31 UTC
- figures: `results/phantom_paper/figures/fig0c_drop_one_oracle.png`, `results/phantom_paper/figures/fig0c_phantom_lift_bars.png` | last update: 2026-08-12 04:33 UTC
...
- source: `results/phantom_paper/phantom_lift.csv` | last update: 2026-08-12 04:31 UTC
- figure: `results/phantom_paper/figures/fig0d_taskpool_jaccard.png` | last update: 2026-08-12 04:33 UTC
...
- figure: `results/phantom_paper/figures/fig0f_overlap_stacked_bar.png` | last update: 2026-08-12 04:33 UTC
...
- source: `results/phantom_paper/auroc_cross_condition.csv` | last update: 2026-08-12 04:31 UTC
- figure: `results/phantom_paper/figures/fig0g_routing_auroc_heatmap.png` | last update: 2026-08-12 04:33 UTC
...
- source: `docs/analysis/cross_sites/axis_effect_size.json` | last update: 2026-08-12 04:33 UTC
...
- figure: `results/phantom_paper/figures/fig1c_strategy_gradient.png` | last update: 2026-08-12 04:34 UTC
...
- source: `docs/analysis/cross_sites/axis1_microbehavior.json` | last update: 2026-08-12 04:33 UTC
- figure: `results/phantom_paper/figures/fig2_micro_divergence_heatmap.png` | last update: 2026-08-12 04:34 UTC
...
- source: `results/phantom_paper/run_summary_collect.json` plus episode `total_tokens` fallback | last update: 2026-08-12 04:31 UTC
...
- source: `docs/analysis/cross_sites/cost_per_mode.json` | last update: 2026-08-12 04:31 UTC
- figure: `results/phantom_paper/figures/fig3d_cost_sr_frontier.png` | last update: 2026-08-12 04:35 UTC
...
| (ii) Most apparent oracle headroom is rerun variance; the bound that survives the rerun control is the cost ceiling at unchanged success | 0c, 3a | `noise_floor_inventory.md` | ✅ but read §1b there: the observed band is a draw, not a bound |
...
| (iv) **NEW** Which routing question is answerable is decided by label supply AND signal, and those fail separately | 0b-extra, 0g | `abstention_learnability.md`, `early_abort_B0_classifieds.md`, `retry_vs_switch_label_supply.md` | ✅ four questions, one works — see next table |
...
| **Abstain before running** | **every task has one** | **present** | **works — the only held-out cost saving in the paper** | `abstention_learnability.md` |
...
|---|---|---|---|
| D1 | Fusion does not earn its premium against a rerun of one arm | 0a, 0c | `fusion_premium.md` |
