...
Generated: 2026-04-29 16:33 UTC  
...
- reddit: DOM raw 11.43% / adj **9.52%**; P-DOM raw 13.81% / adj **12.38%**; P-SoM raw 14.29% / adj **13.81%**; SoM raw 11.90% / adj **10.48%**; Vision raw 8.57% / adj **6.67%**
- classifieds: DOM raw 14.96% / adj **14.10%**; P-DOM raw 16.67% / adj **14.53%**; P-SoM raw 15.81% / adj **14.53%**; SoM raw 23.08% / adj **21.37%**; Vision raw 15.81% / adj **13.68%**
- source: `results/visualwebarena/phase1/B0_*/*/episodes/*_summary_v2.json` (live); last update: 2026-04-29 14:29 UTC
- standalone cite source: `docs/analysis/cross_sites/sr_fp_per_mode.md` | last update: 2026-04-29 14:59 UTC

### 0b FP rate (raw success - adjusted success)

- reddit: DOM 1.90%; P-DOM 1.43%; P-SoM 0.48%; SoM 1.43%; Vision 1.90%
- classifieds: DOM 0.85%; P-DOM 2.14%; P-SoM 1.28%; SoM 1.71%; Vision 2.14%
- source: same live episode `summary_v2.json` files as 0a; standalone `docs/analysis/cross_sites/sr_fp_per_mode.md` | last update: 2026-04-29 14:59 UTC
...
- source: `docs/analysis/cross_sites/mechanism_per_task.json` | last update: 2026-04-29 16:33 UTC

### 0c Routing oracle (3→5-mode lift)

- classifieds: **+4.70pp** [2.14, 7.69] Wilcoxon p=0.0009, McNemar p=0.0005 ✅
  - single phantom lifts: +P-DOM +3.42pp; +P-SoM +2.56pp
- reddit: **+5.24pp** [2.38, 8.11] Wilcoxon p=0.0009, McNemar p=0.0005 ✅
  - single phantom lifts: +P-DOM +3.81pp; +P-SoM +3.33pp
- source: `results/phantom_paper/phantom_lift.csv` | last update: 2026-04-29 14:59 UTC
- figures: `results/phantom_paper/figures/fig0c_drop_one_oracle.png`, `results/phantom_paper/figures/fig0c_phantom_lift_bars.png` | last update: 2026-04-29 15:55 UTC

### 0d Task-pool Jaccard (Scenario C sentinel)

- classifieds: P-DOM↔P-SoM Jaccard **0.447** (✅ safe); threshold ≤0.7
- reddit: P-DOM↔P-SoM Jaccard **0.571** (✅ safe); threshold ≤0.7
- source: `results/phantom_paper/phantom_lift.csv` | last update: 2026-04-29 14:59 UTC
- figure: `results/phantom_paper/figures/fig0d_taskpool_jaccard.png` | last update: 2026-04-29 14:59 UTC
...
- figure: `results/phantom_paper/figures/fig0e_category_mode_heatmap.png` | last update: 2026-04-29 14:59 UTC

### 0f Overlap depth

- reddit P-SoM: d1=3 / d2=8 / d3=7 / d4=9 / d5=2
- reddit P-DOM: d1=4 / d2=5 / d3=6 / d4=9 / d5=2
- classifieds P-SoM: d1=3 / d2=7 / d3=7 / d4=10 / d5=7
- classifieds P-DOM: d1=5 / d2=7 / d3=7 / d4=8 / d5=7
- figure: `results/phantom_paper/figures/fig0f_overlap_stacked_bar.png` | last update: 2026-04-29 14:59 UTC

### 0g Routing AUROC

- reddit: dom 0.817 (ep_mean_verbalized); phantom_dom 0.793 (ep_mean_verbalized); phantom_som 0.720 (ep_mean_verbalized); som 0.719 (ep_mean_verbalized); vision 0.778 (ep_mean_verbalized)
- classifieds: dom 0.769 (action_diversity); phantom_dom 0.737 (ep_mean_verbalized); phantom_som 0.728 (action_diversity); som 0.709 (ep_mean_verbalized); vision 0.773 (max_repeat_streak)
- source: `results/phantom_paper/auroc_cross_condition.csv` | last update: 2026-04-29 14:59 UTC
- figure: `results/phantom_paper/figures/fig0g_routing_auroc_heatmap.png` | last update: 2026-04-29 14:59 UTC
...
- source: `docs/analysis/cross_sites/axis_effect_size.json` | last update: 2026-04-29 14:59 UTC
...
- figure: `results/phantom_paper/figures/fig1c_strategy_gradient.png` | last update: 2026-04-29 14:59 UTC
...
- source: `docs/analysis/cross_sites/axis1_microbehavior.json` | last update: 2026-04-29 15:00 UTC
- figure: `results/phantom_paper/figures/fig2_micro_divergence_heatmap.png` | last update: 2026-04-29 15:00 UTC
...
- source: `results/phantom_paper/run_summary_collect.json` plus episode `total_tokens` fallback | last update: 2026-04-29 15:00 UTC
...
- classifieds: B0 API $0.0386/ep vs B1 electricity $0.000366/ep → **105x** deployment-class gap
- ⚠️ §103 / paper-planning legacy '30×' claim **superseded** by these data — real ratio ~100× (deployment class, not capability ratio)
- source: `docs/analysis/cross_sites/cost_per_mode.json` | last update: 2026-04-29 15:00 UTC
- figure: `results/phantom_paper/figures/fig3d_cost_sr_frontier.png` | last update: 2026-04-29 16:06 UTC
