...
- canonical source: `docs/analysis/cross_sites/sr_per_mode.json` | last update: 2026-08-03 18:30 UTC
- standalone cite source: `docs/analysis/cross_sites/sr_per_mode.md` | last update: 2026-08-03 18:30 UTC
...
- source: `docs/analysis/cross_sites/mechanism_per_task.json` | last update: 2026-08-03 18:31 UTC
...
- source: `results/phantom_paper/phantom_lift.csv` | last update: 2026-08-03 18:30 UTC
- figures: `results/phantom_paper/figures/fig0c_drop_one_oracle.png`, `results/phantom_paper/figures/fig0c_phantom_lift_bars.png` | last update: 2026-08-03 18:32 UTC
...
- source: `results/phantom_paper/phantom_lift.csv` | last update: 2026-08-03 18:30 UTC
- figure: `results/phantom_paper/figures/fig0d_taskpool_jaccard.png` | last update: 2026-08-03 18:32 UTC
...
- figure: `results/phantom_paper/figures/fig0f_overlap_stacked_bar.png` | last update: 2026-08-03 18:32 UTC
...
- source: `results/phantom_paper/auroc_cross_condition.csv` | last update: 2026-08-03 18:30 UTC
- figure: `results/phantom_paper/figures/fig0g_routing_auroc_heatmap.png` | last update: 2026-08-03 18:32 UTC
...
- source: `docs/analysis/cross_sites/axis_effect_size.json` | last update: 2026-08-03 18:32 UTC
...
- figure: `results/phantom_paper/figures/fig1c_strategy_gradient.png` | last update: 2026-08-03 18:33 UTC

### 1d Full action vocabulary (E4)

- reddit: compound DOM→P-SoM top shifts: tab_focus 0.078; scroll -0.042; finish -0.033
...
- source: `docs/analysis/cross_sites/axis1_microbehavior.json` | last update: 2026-08-03 18:32 UTC
- figure: `results/phantom_paper/figures/fig2_micro_divergence_heatmap.png` | last update: 2026-08-03 18:33 UTC

### 2a-extra Click-target divergence (E1)

- reddit: axis-1 click-transition Jaccard **0.335**; compound DOM↔P-SoM **0.310**
...
- source: `results/phantom_paper/run_summary_collect.json` plus episode `total_tokens` fallback | last update: 2026-08-03 18:30 UTC
...
- source: `docs/analysis/cross_sites/cost_per_mode.json` | last update: 2026-08-03 18:30 UTC
- figure: `results/phantom_paper/figures/fig3d_cost_sr_frontier.png` | last update: 2026-08-03 18:34 UTC
