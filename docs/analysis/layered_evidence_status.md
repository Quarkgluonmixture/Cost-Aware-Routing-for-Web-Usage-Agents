...
Generated: 2026-05-01 11:07 UTC  
...
- source: `results/visualwebarena/phase1/B0_*/*/episodes/*_summary_v2.json` (live); last update: 2026-05-01 11:01 UTC
- standalone cite source: `docs/analysis/cross_sites/sr_fp_per_mode.md` | last update: 2026-05-01 11:07 UTC
...
- source: same live episode `summary_v2.json` files as 0a; standalone `docs/analysis/cross_sites/sr_fp_per_mode.md` | last update: 2026-05-01 11:07 UTC

### 0b-extra Confidence calibration (E3)

- B0 reddit: best routing AUROC Phantom-prompt **0.817**; ECE n/a in existing outputs
...
- source: `docs/analysis/cross_sites/mechanism_per_task.json` | last update: 2026-05-01 11:07 UTC
...
- source: `results/phantom_paper/phantom_lift.csv` | last update: 2026-05-01 11:07 UTC
- figures: `results/phantom_paper/figures/fig0c_drop_one_oracle.png`, `results/phantom_paper/figures/fig0c_phantom_lift_bars.png` | last update: 2026-05-01 11:07 UTC
...
- source: `results/phantom_paper/phantom_lift.csv` | last update: 2026-05-01 11:07 UTC
- figure: `results/phantom_paper/figures/fig0d_taskpool_jaccard.png` | last update: 2026-05-01 11:07 UTC
...
- figure: `results/phantom_paper/figures/fig0e_category_mode_heatmap.png` | last update: 2026-05-01 11:07 UTC
...
- figure: `results/phantom_paper/figures/fig0f_overlap_stacked_bar.png` | last update: 2026-05-01 11:07 UTC

### 0g Routing AUROC

- reddit: DOM 0.817 (ep_mean_verbalized); P-text 0.793 (ep_mean_verbalized); P-prompt 0.817 (ep_mean_verbalized); P-SoM 0.720 (ep_mean_verbalized); SoM 0.719 (ep_mean_verbalized); Vision 0.778 (ep_mean_verbalized)
...
- source: `results/phantom_paper/auroc_cross_condition.csv` | last update: 2026-05-01 11:07 UTC
- figure: `results/phantom_paper/figures/fig0g_routing_auroc_heatmap.png` | last update: 2026-05-01 11:07 UTC
...
- source: `docs/analysis/cross_sites/axis_effect_size.json` | last update: 2026-05-01 11:07 UTC
...
- figure: `results/phantom_paper/figures/fig1c_strategy_gradient.png` | last update: 2026-05-01 11:07 UTC
...
- source: `docs/analysis/cross_sites/axis1_microbehavior.json` | last update: 2026-05-01 11:07 UTC
- figure: `results/phantom_paper/figures/fig2_micro_divergence_heatmap.png` | last update: 2026-05-01 11:07 UTC
...
- source: `results/phantom_paper/run_summary_collect.json` plus episode `total_tokens` fallback | last update: 2026-05-01 11:07 UTC
...
- source: `docs/analysis/cross_sites/cost_per_mode.json` | last update: 2026-05-01 11:07 UTC
- figure: `results/phantom_paper/figures/fig3d_cost_sr_frontier.png` | last update: 2026-05-01 11:07 UTC
