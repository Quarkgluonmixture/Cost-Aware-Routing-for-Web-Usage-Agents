...
Generated: 2026-07-31 17:18 UTC
...
- canonical source: `docs/analysis/cross_sites/sr_per_mode.json` | last update: 2026-07-31 17:15 UTC
- standalone cite source: `docs/analysis/cross_sites/sr_per_mode.md` | last update: 2026-07-31 17:15 UTC
...
- source: `docs/analysis/cross_sites/mechanism_per_task.json` | last update: 2026-07-31 17:15 UTC
...
- source: `results/phantom_paper/phantom_lift.csv` | last update: 2026-07-31 17:15 UTC
- figures: `results/phantom_paper/figures/fig0c_drop_one_oracle.png`, `results/phantom_paper/figures/fig0c_phantom_lift_bars.png` | last update: 2026-07-31 17:17 UTC
...
- source: `results/phantom_paper/phantom_lift.csv` | last update: 2026-07-31 17:15 UTC
- figure: `results/phantom_paper/figures/fig0d_taskpool_jaccard.png` | last update: 2026-07-31 17:17 UTC
...
- figure: `results/phantom_paper/figures/fig0f_overlap_stacked_bar.png` | last update: 2026-07-31 17:17 UTC
...
- source: `results/phantom_paper/auroc_cross_condition.csv` | last update: 2026-07-31 17:15 UTC
- figure: `results/phantom_paper/figures/fig0g_routing_auroc_heatmap.png` | last update: 2026-07-31 17:17 UTC
...
- source: `docs/analysis/cross_sites/axis_effect_size.json` | last update: 2026-07-31 17:15 UTC
...
- figure: `results/phantom_paper/figures/fig1c_strategy_gradient.png` | last update: 2026-07-31 17:17 UTC
...
- source: `docs/analysis/cross_sites/axis1_microbehavior.json` | last update: 2026-07-31 17:16 UTC
- figure: `results/phantom_paper/figures/fig2_micro_divergence_heatmap.png` | last update: 2026-07-31 17:17 UTC
...
- source: `results/phantom_paper/run_summary_collect.json` plus episode `total_tokens` fallback | last update: 2026-07-31 17:15 UTC
...
- source: `docs/analysis/cross_sites/cost_per_mode.json` | last update: 2026-07-31 17:15 UTC
- figure: `results/phantom_paper/figures/fig3d_cost_sr_frontier.png` | last update: 2026-07-31 17:18 UTC
