...
Generated: 2026-07-16 01:42 UTC
...
- B0 reddit: DOM **14.63%**; P-text **13.66%**; P-prompt **12.68%**; P-SoM **11.22%**; SoM **14.63%**; Vision **7.80%**
- B0 classifieds: DOM **17.41%**; P-text **15.62%**; P-prompt **19.64%**; P-SoM **15.62%**; SoM **27.23%**; Vision **25.00%**
- B1 reddit: DOM **6.83%**; P-text **6.83%**; P-prompt **6.34%**; P-SoM **6.83%**; SoM **8.29%**; Vision **2.93%**
...
- canonical source: `docs/analysis/cross_sites/sr_per_mode.json` | last update: 2026-07-16 01:41 UTC
- standalone cite source: `docs/analysis/cross_sites/sr_per_mode.md` | last update: 2026-07-16 01:41 UTC
...
- source: `docs/analysis/cross_sites/mechanism_per_task.json` | last update: 2026-07-16 01:41 UTC
...
- source: `results/phantom_paper/phantom_lift.csv` | last update: 2026-07-16 01:41 UTC
- figures: `results/phantom_paper/figures/fig0c_drop_one_oracle.png`, `results/phantom_paper/figures/fig0c_phantom_lift_bars.png` | last update: 2026-07-16 01:41 UTC
...
- source: `results/phantom_paper/phantom_lift.csv` | last update: 2026-07-16 01:41 UTC
- figure: `results/phantom_paper/figures/fig0d_taskpool_jaccard.png` | last update: 2026-07-16 01:41 UTC
...
- figure: `results/phantom_paper/figures/fig0f_overlap_stacked_bar.png` | last update: 2026-07-16 01:41 UTC
...
- source: `results/phantom_paper/auroc_cross_condition.csv` | last update: 2026-07-16 01:41 UTC
- figure: `results/phantom_paper/figures/fig0g_routing_auroc_heatmap.png` | last update: 2026-07-16 01:41 UTC
...
- source: `docs/analysis/cross_sites/axis_effect_size.json` | last update: 2026-07-16 01:41 UTC
...
- figure: `results/phantom_paper/figures/fig1c_strategy_gradient.png` | last update: 2026-07-16 01:41 UTC
...
- source: `docs/analysis/cross_sites/axis1_microbehavior.json` | last update: 2026-07-16 01:41 UTC
- figure: `results/phantom_paper/figures/fig2_micro_divergence_heatmap.png` | last update: 2026-07-16 01:41 UTC
...
- source: `results/phantom_paper/run_summary_collect.json` plus episode `total_tokens` fallback | last update: 2026-07-16 01:41 UTC
...
- source: `docs/analysis/cross_sites/cost_per_mode.json` | last update: 2026-07-16 01:41 UTC
- figure: `results/phantom_paper/figures/fig3d_cost_sr_frontier.png` | last update: 2026-07-16 01:42 UTC
