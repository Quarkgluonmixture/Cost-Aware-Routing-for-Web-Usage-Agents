...
Generated: 2026-05-04 13:06 UTC  
...
- classifieds: DOM raw 14.96% / adj **14.10%**; P-text raw 16.67% / adj **14.53%**; P-prompt raw 25.00% / adj **25.00%**; P-SoM raw 15.81% / adj **14.53%**; SoM raw 23.08% / adj **21.37%**; Vision raw 15.81% / adj **13.68%**
- source: `results/visualwebarena/phase1/B0_*/*/episodes/*_summary_v2.json` (live); last update: 2026-05-04 13:01 UTC
- standalone cite source: `docs/analysis/cross_sites/sr_fp_per_mode.md` | last update: 2026-05-04 13:05 UTC

### 0b FP rate (raw success - adjusted success)

- reddit: DOM 1.90%; P-text 1.43%; P-prompt 0.95%; P-SoM 0.48%; SoM 1.43%; Vision 1.90%
- classifieds: DOM 0.85%; P-text 2.14%; P-prompt 0.00%; P-SoM 1.28%; SoM 1.71%; Vision 2.14%
- source: same live episode `summary_v2.json` files as 0a; standalone `docs/analysis/cross_sites/sr_fp_per_mode.md` | last update: 2026-05-04 13:05 UTC
...
- source: `docs/analysis/cross_sites/mechanism_per_task.json` | last update: 2026-05-04 13:05 UTC
...
- source: `results/phantom_paper/phantom_lift.csv` | last update: 2026-05-04 13:05 UTC
- figures: `results/phantom_paper/figures/fig0c_drop_one_oracle.png`, `results/phantom_paper/figures/fig0c_phantom_lift_bars.png` | last update: 2026-05-04 13:06 UTC
...
- source: `results/phantom_paper/phantom_lift.csv` | last update: 2026-05-04 13:05 UTC
- figure: `results/phantom_paper/figures/fig0d_taskpool_jaccard.png` | last update: 2026-05-04 13:06 UTC
...
- figure: `results/phantom_paper/figures/fig0e_category_mode_heatmap.png` | last update: 2026-05-04 13:06 UTC
...
- classifieds P-text: d1=4 / d2=8 / d3=7 / d4=8 / d5=7 / d6=0
- classifieds P-prompt: d1=0 / d2=1 / d3=0 / d4=0 / d5=0 / d6=0
- figure: `results/phantom_paper/figures/fig0f_overlap_stacked_bar.png` | last update: 2026-05-04 13:06 UTC
...
- source: `results/phantom_paper/auroc_cross_condition.csv` | last update: 2026-05-04 13:05 UTC
- figure: `results/phantom_paper/figures/fig0g_routing_auroc_heatmap.png` | last update: 2026-05-04 13:06 UTC
...
- source: `docs/analysis/cross_sites/axis_effect_size.json` | last update: 2026-05-04 13:06 UTC
...
- figure: `results/phantom_paper/figures/fig1c_strategy_gradient.png` | last update: 2026-05-04 13:06 UTC
...
- source: `docs/analysis/cross_sites/axis1_microbehavior.json` | last update: 2026-05-04 13:06 UTC
- figure: `results/phantom_paper/figures/fig2_micro_divergence_heatmap.png` | last update: 2026-05-04 13:06 UTC
...
- source: `results/phantom_paper/run_summary_collect.json` plus episode `total_tokens` fallback | last update: 2026-05-04 13:05 UTC
...
- source: `docs/analysis/cross_sites/cost_per_mode.json` | last update: 2026-05-04 13:05 UTC
- figure: `results/phantom_paper/figures/fig3d_cost_sr_frontier.png` | last update: 2026-05-04 13:06 UTC
