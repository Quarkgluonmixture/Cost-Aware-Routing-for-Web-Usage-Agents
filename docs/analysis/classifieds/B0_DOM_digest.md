...
## FP 分类统计（B0 DOM，当前已跑 episodes）

**成功总数：35**（raw SR ~15%，234 tasks）
...
**Adjusted SR**：7.7%（18/234，现行过滤）；严格下界 0.4%（1/234）；报告使用 7.7%，注明区间。
...
| 指标 | DOM | SoM | Vision |
|------|-----|-----|--------|
| Raw SR | 15.02% (35/233) | 15.81% (37/234) | 14.10% (33/234) |
| Adjusted SR | **8.07%** (18/223) | **12.05%** (27/224) | **10.71%** (24/224) |
| FP 分解 | 7 N/A + 10 visual FP | 10 N/A FP | 9 N/A FP |
| avg steps | 14.10 | 8.27 | 8.02 |
| cost/ep | $0.0457 | $0.0411 | $0.0256 |

> DOM adjusted SR 注：严格下界 0.4%（1/234 真实成功 task_217）；现行过滤 8.07%（扣除 7 N/A FP + 10 kwd visual FP，§56 盲区 17 tasks 暂计为成功）；报告使用 8.07%，注明为上界估计。
> 与 B1 对比：DOM 8.07% vs B1 0.85%（9.5×）；SoM 12.05% vs B1 16.24%（反转，见 B0_B1_findings.md）；Vision 10.71% vs B1 8.12%。

---

*最后更新：2026-04-14（新增：B0 vs B1 三项能力差异；视觉幻觉 Task 222/233；FP 分类统计表；§56 盲区分级）*
