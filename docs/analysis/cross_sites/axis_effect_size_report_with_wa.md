...
| B1 | wa_reddit | search loop | h=-0.12; -5.77 pp; [-14.42, +3.85] | h=-0.27★; -13.46 pp; [-23.08, -3.85] | ✅ | ✅ |
| B1 | wa_reddit | type fraction | d_z=-0.28★; -7.07 pp; [-11.97, -2.16] | d_z=-0.11; -3.08 pp; [-8.33, +2.24] | ✅ | ✅ |
| B1 | wa_reddit | scroll fraction | d_z=-0.06; -0.60 pp; [-2.41, +1.12] | d_z=+0.15; +1.82 pp; [-0.36, +4.13] | — | ✅ |
| B1 | wa_reddit | self-correction | d_z=-0.01; -0.01; [-0.36, +0.25] | d_z=+0.11; +0.21; [-0.13, +0.58] | — | ✅ |
| B1 | wa_reddit | click fraction | d_z=+0.35★; +10.96 pp; [+5.24, +16.65] | d_z=-0.18★; -7.01 pp; [-14.10, +0.59] | ✅ | ✅ |
| B1 | wa_reddit | finish rate | h=-0.08; -3.85 pp; [-13.46, +5.77] | h=-0.02; -0.96 pp; [-10.58, +8.68] | — | — |
| B1 | wa_reddit | step count | d_z=+0.12; +1.14; [-0.63, +2.94] | d_z=+0.01; +0.12; [-2.20, +2.47] | ✅ | — |
| B1 | wa_reddit | action repeat | d_z=+0.17; +5.07 pp; [-0.79, +10.60] | d_z=+0.03; +1.05 pp; [-5.86, +7.88] | ✅ | — |
...
| B1 | wa_reddit | search loop | h=+0.08; +3.85 pp; [-3.85, +11.54] | h=-0.20★; -9.62 pp; [-17.31, -1.92] | h=-0.27★; -13.46 pp; [-23.08, -3.85] | image | pass |
| B1 | wa_reddit | type fraction | d_z=-0.02; -0.31 pp; [-4.28, +3.59] | d_z=-0.27★; -6.75 pp; [-11.41, -2.14] | d_z=-0.11; -3.08 pp; [-8.33, +2.24] | prompt | pass |
| B1 | wa_reddit | scroll fraction | d_z=+0.07; +0.49 pp; [-0.82, +1.72] | d_z=-0.13; -1.08 pp; [-2.64, +0.46] | d_z=+0.15; +1.82 pp; [-0.36, +4.13] | image | pass |
| B1 | wa_reddit | self-correction | d_z=+0.15; +0.20; [-0.05, +0.47] | d_z=-0.14; -0.21; [-0.56, +0.07] | d_z=+0.11; +0.21; [-0.13, +0.58] | text | pass |
| B1 | wa_reddit | click fraction | d_z=+0.15; +3.55 pp; [-0.60, +7.95] | d_z=+0.24★; +7.40 pp; [+1.80, +13.10] | d_z=-0.18★; -7.01 pp; [-14.10, +0.59] | prompt | pass |
| B1 | wa_reddit | finish rate | h=+0.12; +5.77 pp; [-3.85, +15.38] | h=-0.20★; -9.62 pp; [-19.23, -0.96] | h=-0.02; -0.96 pp; [-10.58, +8.68] | prompt | pass |
| B1 | wa_reddit | step count | d_z=+0.07; +0.68; [-1.16, +2.53] | d_z=+0.06; +0.46; [-1.04, +2.04] | d_z=+0.01; +0.12; [-2.20, +2.47] | neither (all small) | pass |
| B1 | wa_reddit | action repeat | d_z=-0.03; -0.92 pp; [-6.01, +4.22] | d_z=+0.22★; +5.99 pp; [+0.50, +11.11] | d_z=+0.03; +1.05 pp; [-5.86, +7.88] | prompt | pass |
...
| B1 | wa_reddit | search loop | -5.77 | +nan | -5.77 | -0.000 | +nan | ⚠️ n differs across legs |
| B1 | wa_reddit | type fraction | -0.07 | +nan | -0.07 | +0.000 | +nan | ⚠️ n differs across legs |
| B1 | wa_reddit | scroll fraction | -0.01 | +nan | -0.01 | +0.000 | +nan | ⚠️ n differs across legs |
| B1 | wa_reddit | self-correction | -0.01 | +nan | -0.01 | +0.000 | +nan | ⚠️ n differs across legs |
| B1 | wa_reddit | click fraction | +0.11 | +nan | +0.11 | +0.000 | +nan | ⚠️ n differs across legs |
| B1 | wa_reddit | finish rate | -3.85 | +nan | -3.85 | +0.000 | +nan | ⚠️ n differs across legs |
| B1 | wa_reddit | step count | +1.14 | +nan | +1.14 | +0.000 | +nan | ⚠️ n differs across legs |
| B1 | wa_reddit | action repeat | +0.05 | +nan | +0.05 | +0.000 | +nan | ⚠️ n differs across legs |
...
- B1 wa_reddit / scroll fraction: prompt vs image (d_z=-0.13 vs +0.15) -> antagonistic
- B1 wa_reddit / self-correction: text vs prompt (d_z=+0.15 vs -0.14) -> antagonistic
- B1 wa_reddit / self-correction: prompt vs image (d_z=-0.14 vs +0.11) -> antagonistic
- B1 wa_reddit / click fraction: text vs image (d_z=+0.15 vs -0.18) -> antagonistic
- B1 wa_reddit / click fraction: prompt vs image (d_z=+0.24 vs -0.18) -> antagonistic
- B1 wa_reddit / finish rate: text vs prompt (h=+0.12 vs -0.20) -> antagonistic
