...
| reddit | Phantom-DOM | 210 | 13.81% | 12.38% | 3 | 1.43% | na_fp=3 |
...
| classifieds | Phantom-DOM | 234 | 16.67% | 14.53% | 5 | 2.14% | na_fp=5 |
...
- reddit: Phantom-SoM 0.48% < Phantom-DOM 1.43% < SoM 1.43% < DOM 1.90% < Vision 1.90%
- classifieds: DOM 0.85% < Phantom-SoM 1.28% < SoM 1.71% < Phantom-DOM 2.14% < Vision 2.14%
