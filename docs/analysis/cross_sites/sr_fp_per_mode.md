...
| B0 | reddit | P-prompt | 210 | 10.48% | 9.52% | 2 | 0.95% | na_fp=2 |
| B0 | reddit | P-SoM | 210 | 14.29% | 13.81% | 1 | 0.48% | na_fp=1 |
...
| B0 | classifieds | P-SoM | 234 | 15.81% | 14.53% | 3 | 1.28% | na_fp=3 |
...
| B1 | classifieds | P-text | 234 | 10.26% | 7.26% | 7 | 2.99% | na_fp=7 |
| B1 | classifieds | P-SoM | 234 | 10.26% | 7.69% | 6 | 2.56% | na_fp=6 |

## FP rate ranking per (baseline, site)

- B0 reddit: P-SoM 0.48% < P-prompt 0.95% < P-text 1.43% < SoM 1.43% < DOM 1.90% < Vision 1.90%
- B0 classifieds: DOM 0.85% < P-SoM 1.28% < SoM 1.71% < P-text 2.14% < Vision 2.14%
- B1 reddit: DOM 2.38% < SoM 2.38% < Vision 2.38%
- B1 classifieds: DOM 2.56% < P-SoM 2.56% < P-text 2.99% < SoM 3.85% < Vision 3.85%
