...
- **41 digests**: 3 with a machine-readable three-way table · 9 that declare their own attribution incomplete · 29 whose table this script could not parse
...
|---|---|---|---|---|---|---|---|---|
| B0 | classifieds | dom | ❔ 未解析 | — | **?** | **?** | **?** | — |
| B0 | classifieds | phantom_prompt | ❔ 未解析 | — | **?** | **?** | **?** | FP |
| B0 | classifieds | phantom_som | ❔ 未解析 | — | **?** | **?** | **?** | FP |
| B0 | classifieds | phantom_text | ✅ | — | 188 (100%) | — | 0 (0%) | — |
| B0 | classifieds | som | ⚠️ 自称不完整 | — | **?** | **?** | **?** | scaffold |
| B0 | classifieds | vision | ❔ 未解析 | — | **?** | **?** | **?** | — |
| B0 | reddit | dom | ✅ | 175 | 175 (100%) | 0 (0%) | 0 (0%) | FP |
| B0 | reddit | phantom_prompt | ❔ 未解析 | — | **?** | **?** | **?** | FP |
| B0 | reddit | phantom_som | ❔ 未解析 | — | **?** | **?** | **?** | FP |
| B0 | reddit | phantom_text | ❔ 未解析 | — | **?** | **?** | **?** | scaffold, FP |
| B0 | reddit | som | ⚠️ 自称不完整 | — | **?** | **?** | **?** | FP |
| B0 | reddit | vision | ❔ 未解析 | — | **?** | **?** | **?** | FP |
| B1 | classifieds | dom | ❔ 未解析 | — | **?** | **?** | **?** | — |
| B1 | classifieds | phantom_prompt | ❔ 未解析 | — | **?** | **?** | **?** | — |
| B1 | classifieds | phantom_som | ❔ 未解析 | — | **?** | **?** | **?** | — |
| B1 | classifieds | phantom_text | ❔ 未解析 | — | **?** | **?** | **?** | — |
| B1 | classifieds | som | ❔ 未解析 | — | **?** | **?** | **?** | scaffold, FP |
| B1 | classifieds | vision | ❔ 未解析 | — | **?** | **?** | **?** | — |
| B1 | reddit | dom | ❔ 未解析 | — | **?** | **?** | **?** | FP |
| B1 | reddit | phantom_prompt | ❔ 未解析 | — | **?** | **?** | **?** | FP |
| B1 | reddit | phantom_som | ❔ 未解析 | — | **?** | **?** | **?** | FP |
| B1 | reddit | phantom_text | ❔ 未解析 | — | **?** | **?** | **?** | FP |
| B1 | reddit | som | ❔ 未解析 | — | **?** | **?** | **?** | FP |
| B1 | reddit | vision | ❔ 未解析 | — | **?** | **?** | **?** | FP |
| B2 | classifieds | dom | ❔ 未解析 | — | **?** | **?** | **?** | FP |
| B2 | classifieds | phantom_prompt | ❔ 未解析 | — | **?** | **?** | **?** | — |
| B2 | classifieds | phantom_som | ❔ 未解析 | — | **?** | **?** | **?** | — |
| B2 | classifieds | phantom_text | ❔ 未解析 | — | **?** | **?** | **?** | — |
| B2 | classifieds | som | ❔ 未解析 | — | **?** | **?** | **?** | — |
| B2 | classifieds | vision | ❔ 未解析 | — | **?** | **?** | **?** | — |
...
- **B0_dom_classifieds_R21557** — free-text scaffold mention · `docs/analysis/vwa_classifieds/B0_dom_classifieds_R21557_diag_digest.md`
...
- **B0_som_classifieds** — free-text scaffold mention · `docs/analysis/vwa_classifieds/B0_som_classifieds_diag_digest.md`
...
- **B0_phantom_som_reddit** — free-text benchmark-FP mention · `docs/analysis/vwa_reddit/B0_phantom_som_reddit_diag_digest.md`
- **B0_phantom_text_reddit** — free-text scaffold mention; free-text benchmark-FP mention · `docs/analysis/vwa_reddit/B0_phantom_text_reddit_diag_digest.md`
- **B0_som_reddit** — free-text benchmark-FP mention · `docs/analysis/vwa_reddit/B0_som_reddit_diag_digest.md`
- **B0_vision_reddit** — free-text benchmark-FP mention · `docs/analysis/vwa_reddit/B0_vision_reddit_diag_digest.md`
...
- **B1_dom_reddit** — free-text benchmark-FP mention · `docs/analysis/vwa_reddit/B1_dom_reddit_diag_digest.md`
- **B1_phantom_prompt_reddit** — free-text benchmark-FP mention · `docs/analysis/vwa_reddit/B1_phantom_prompt_reddit_diag_digest.md`
- **B1_phantom_som_reddit** — free-text benchmark-FP mention · `docs/analysis/vwa_reddit/B1_phantom_som_reddit_diag_digest.md`
- **B1_phantom_text_reddit** — free-text benchmark-FP mention · `docs/analysis/vwa_reddit/B1_phantom_text_reddit_diag_digest.md`
- **B1_som_reddit** — free-text benchmark-FP mention · `docs/analysis/vwa_reddit/B1_som_reddit_diag_digest.md`
- **B1_vision_reddit** — free-text benchmark-FP mention · `docs/analysis/vwa_reddit/B1_vision_reddit_diag_digest.md`
...
**Not admissible.** Only 3/41 digests expose a machine-readable attribution table, so no statement of the form "the pipeline is clean across all conditions" can be made from this index. The per-condition rows above are the usable unit.
...
- `B0_dom_classifieds_R21557` (R21557) — ❔ 未解析 · `docs/analysis/vwa_classifieds/B0_dom_classifieds_R21557_diag_digest.md`
- `B0_vision_classifieds_R24792` (R24792) — ❔ 未解析 · `docs/analysis/vwa_classifieds/B0_vision_classifieds_R24792_diag_digest.md`
- `B0_vision_classifieds_R32024` (R32024) — ✅ · `docs/analysis/vwa_classifieds/B0_vision_classifieds_R32024_diag_digest.md`
- `B2_dom_classifieds_R17895` (R17895) — ❔ 未解析 · `docs/analysis/vwa_classifieds/B2_dom_classifieds_R17895_diag_digest.md`
