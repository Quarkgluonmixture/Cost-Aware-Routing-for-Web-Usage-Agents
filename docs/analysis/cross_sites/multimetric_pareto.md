...
Latency spans the same order of magnitude as cost, and in **3 of 6** cells the cheapest mode is not the fastest. It is a second axis, not a restatement of the first.
