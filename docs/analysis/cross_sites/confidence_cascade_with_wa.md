...
### `wa_red_B1` (n=104, cheap 9.62%, oracle 16.35%)

| frac | k | SR | cost | SR gain | random gain | margin |
|---|---|---|---|---|---|---|
| 0% | 0 | 9.62% | 1.00x | +0.00pp | +0.00pp | +0.00pp |
| 5% | 5 | 10.58% | 1.07x | +0.96pp | +0.18pp | +0.78pp |
| 10% | 10 | 10.58% | 1.15x | +0.96pp | +0.37pp | +0.59pp |
| 15% | 16 | 10.58% | 1.26x | +0.96pp | +0.59pp | +0.37pp |
| 20% | 21 | 12.50% | 1.36x | +2.88pp | +0.78pp | +2.11pp |
| 30% | 31 | 13.46% | 1.56x | +3.85pp | +1.15pp | +2.70pp |
| 40% | 42 | 13.46% | 1.80x | +3.85pp | +1.55pp | +2.29pp |
