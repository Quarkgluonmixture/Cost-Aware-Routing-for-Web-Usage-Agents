...
>
> **2026-04-26 更新**：所有 condition 经过 §97 rederive（PUR 重算 → eval FP 判定更新），数字相对 04-25 漂移 0.1-1.7pp，文字结论不变。Reddit B1 SoM 是 max_marks 80→200 重跑版本（§94），反转未消失。Adjusted SR 分母用 /234 (classifieds) 或 /210 (reddit)，与 cross_representation 一致。
...
| Baseline | Mode | 进度 | Raw SR | Adjusted SR | 状态 |
|----------|------|------|--------|-------------|------|
| **B0** (235B API) | dom | **234/234** | 14.96% (35) | **14.10%** (33) | ✅ 完成 |
| | som | **234/234** | 23.08% (54) | **21.37%** (50) | ✅ 完成 |
| | vision | **234/234** | 15.81% (37) | **13.68%** (32) | ✅ 完成 |
| **B1** (4B local) | dom | **234/234** | 11.11% (26) | **8.55%** (20) | ✅ 完成 |
| | som | **234/234** | 17.52% (41) | **13.25%** (31) | ✅ 完成 |
| | vision | **234/234** | 11.11% (26) | **7.26%** (17) | ✅ 完成 |

### Reddit (210 tasks)

| Baseline | Mode | 进度 | Raw SR | Adjusted SR | 状态 |
|----------|------|------|--------|-------------|------|
| **B0** (235B API) | dom | **210/210** | 11.43% (24) | **8.10%** (17) | ✅ 完成 |
| | som | **210/210** | 11.90% (25) | **10.48%** (22) | ✅ 完成 |
| | vision | **210/210** | 8.57% (18) | **6.67%** (14) | ✅ 完成 |
| **B1** (4B local) | dom | **210/210** | 10.00% (21) | **6.67%** (14) | ✅ 完成 |
| | som (max_marks=200, §94) | **210/210** | 8.10% (17) | **4.76%** (10) | ✅ 完成（反转未消失） |
| | vision | **210/210** | 4.76% (10) | **1.43%** (3) | ✅ 完成 |

### Shopping (466 tasks)

| Baseline | Mode | 进度 | Raw SR | Adjusted SR | 状态 |
|----------|------|------|--------|-------------|------|
| **B0** (235B API) | dom | **466/466** | 11.80% (55) | 4.37% (19/435) | ✅ 完成 |
| | som | 0/466 | — | — | ❌ 未开始 |
| | vision | 0/466 | — | — | — | ❌ 未开始 |
| **B1** (4B local) | dom | **466/466** | — | — | ✅ resume 完成（04-26 16:44 自动跳过） |
| | som | 0/466 | — | — | 🔄 跑中（自动启动 04-26 16:41） |
| | vision | 0/466 | — | — | ⏳ 等 SoM |
